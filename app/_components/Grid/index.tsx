      ...
      >
        ...
        >
          <CaseStudy
            ...
            image="images/logo-contentboost 1.png"
            title="Content Boost IA(SaaS)"
            href="https://login-content-boost-ai.vercel.app/"
          />
        </div>
        <div
          key="spotify"
        ...
        >
          <CaseStudy
            bg="images/logo-esperar(2).svg"
            image="images/logo-esperar(2).svg"
            title="Landing Page Esperar App"
            href="https://ccd-esperar-landing-ivory.vercel.app/"
          />
        </div>
        <div
          key="blog-excerpt"
        ...
        >
          <CaseStudy
            ...
            title="Get to know my stack"
            href="https://www.linkedin.com/in/jcxmendezz/"
          />
        </div>
        <div
          key="mode-toggle"
